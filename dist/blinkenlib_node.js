...
// the dependencies are met.
            ...
            function findWasmBinary() {
                if (Module['locateFile']) {
                    return locateFile('blinkenlib_node.wasm');
                }
                // Use bundler-friendly `new URL(..., import.meta.url)` pattern; works in browsers too.
                return new URL('blinkenlib_node.wasm', import.meta.url).href;
            }
...
// end include: postlibrary.js
            ...
            var _blinkenlib_spy_address = Module['_blinkenlib_spy_address'] = createExportWrapper('blinkenlib_spy_address', 1);
